    ...
    <div class="col-md-3">
        ...
        <div class="box box-primary">
            <div class="box-body box-profile">
                <img class="profile-user-img img-responsive img-circle" src="{{ asset("/storage/user_images/".Auth::user()->pic) }}" alt="User profile picture">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="settings">
                    {!! Form::model(Auth::user(), ['action' => ['Admin\DashboardController@updateProfile', Auth::user()->id], 'class' => 'form-horizontal', 'method' => "POST", 'enctype' => 'multipart/form-data']) !!}
